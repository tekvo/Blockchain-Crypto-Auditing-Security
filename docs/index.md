...
| Example audit reports | [Audit reports](guides/audit-reports.md) |
| Tools, platforms, and bug frameworks | [Web3 security tools](guides/web3-security-tools.md) |
| EVM internals and low-level work | [EVM low-level coding](guides/evm-low-level-coding.md) |
| Internal audit checklist and roadmap | [Audit roadmap](guides/audit-roadmap.md) |
| Token screening before investing | [Token due diligence](guides/token-due-diligence.md) |
| Secureum resources | [Secureum](guides/secureum.md) |

## Suggested reading order

1. **Types of blockchain attacks** — Threat landscape at the chain, wallet, and contract layers.
2. **Smart contract attacks** and **Blockchain best practices** — Contract bugs paired with defensive patterns.
3. **Web3 security tools** — Tooling and formal methods pointers.
4. **EVM low-level coding** — EVM perspective when reviewing bytecode or gas behavior.
5. **Audit roadmap** — Practical internal audit checklist before external review.
